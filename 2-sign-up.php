<?php 
    ...
    if(isset($_POST['register']))
    {
        ...
        } elseif (strlen($fullname) > 30 || (strlen($fullname)) < 3) {
        $signupError = "Name must be between 3-30 characters";
...
<head>
    ...
    <link rel="icon" href="images/wallet.png" sizes="16x16" type="image/png">
    <link rel="stylesheet" href="2-sign-up.css">
...
<body>
    ...
    <div class="container">
        ...
        <form action="2-sign-up.php" method="post" id="form" onsubmit = "return validate()" enctype="multipart/form-data">
            ...
            <div class="image-preview" id="imagePreview">
                ...
                <span class="image-preview__default-text"><img src="images/userlogo.png" alt=""></span>
            </div>
            ...
            <div class="group">
                ...
                <div class="form-control">
                    ...
                    <input class="fname" onkeypress="return (event.charCode > 64 && 
                        event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" type="text" name="full_name" id="fullname" placeholder="Full Name" required>
                    <br>
                    <small></small>
                </div>
                ...
                <div class="form-control">   
                    <i class="fa fa-key u4" aria-hidden="true"></i>
                    <input type="password" name="password_confirm" id="confirmpassword" placeholder="Confirm Password" autocomplete="on" required>
                    <br>
                    <small></small>
                </div>
    ...
    <script src="2-sign-up.js"></script>
</body>
</html>